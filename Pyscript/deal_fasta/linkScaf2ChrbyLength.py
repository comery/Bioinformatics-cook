...
import sys
if len(sys.argv) < 3:
    sys.exit("python3 {} <assembly.fa> <Num of N to glue>".format(sys.argv[0]))
...
def main():
    ...
    ref_chr_sorted = sorted(scaf_lens.keys(), key=lambda x: scaf_lens[x], reverse=True)
