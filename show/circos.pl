...
#########################creat circos.conf
         ...
         print CONF "<image>\n<<include //ifs4/BC_RD/USER/chenjieyan/circos/circos-0.52/etc/image.conf>>\n</image>\n";
         print CONF "<colors>\n<<include //ifs4/BC_RD/USER/chenjieyan/circos/circos-0.52/etc/colors.conf>>\n</colors>\n";
         print CONF "<fonts>\n<<include //ifs4/BC_RD/USER/chenjieyan/circos/circos-0.52/etc/fonts.conf>>\n</fonts>\n";
         print CONF "chromosomes_display_default=yes\nchromosomes_scale=/./=1rn\n";
         print CONF "<<include //ifs4/BC_RD/USER/chenjieyan/circos/circos-0.52/etc/housekeeping.conf>>\n";
         print CONF "<<include plot.conf>>\n";

         close CONF;

system "perl //ifs4/BC_RD/USER/chenjieyan/circos/circos-0.52/bin/circos -conf circos.conf -outputfile $outputfile";
#system "rm *.txt";
#system "rm *.conf";
#system "rm *.gff";
   }#correct input value
